...
(function () {
  ...
  const DEFAULT_STATE = {
    ...
    habits: [
      ...
      { id: h(), title: '安靜 1 小時 B',      icon: 'ic-shrub',    points: 4 },
      { id: h(), title: '安靜 1 小時 C',      icon: 'ic-shrub',    points: 4 },
      { id: h(), title: '友善 1 小時 A',      icon: 'ic-heart',    points: 4 },
      { id: h(), title: '友善 1 小時 B',      icon: 'ic-heart',    points: 4 },
      { id: h(), title: '友善 1 小時 C',      icon: 'ic-heart',    points: 4 },
      { id: h(), title: '不生氣 1 小時 A',    icon: 'ic-laugh',    points: 4 },
      { id: h(), title: '不生氣 1 小時 B',    icon: 'ic-laugh',    points: 4 },
      { id: h(), title: '不生氣 1 小時 C',    icon: 'ic-laugh',    points: 4 },
      { id: h(), title: '學校表現 A',         icon: 'ic-star',     points: 5 },
      { id: h(), title: '學校表現 B',         icon: 'ic-apple',    points: 2 }
    ],
    rewards: [
      { id: h(), title: '螢幕時間 10 分鐘',   desc: '完成必要任才能換',             icon: 'ic-gamepad',  cost: 1 },
      { id: h(), title: '螢幕時間 30 分鐘',   desc: '完成必要任才能換',             icon: 'ic-gamepad',  cost: 3 },
